// ===============================================
// FUNCIONES PARA EL MANEJO DEL POPUP DE DETALLES
// ===============================================
        ...
        if ((buttonText === 'Ver' || buttonText === 'Revisar') && !button.getAttribute('onclick')) {
            button.addEventListener('click', function() {
                ...
                if (tableId === 'contentConfirmacionesPendientes' || tableId === 'contentConfirmacionesRealizadas') {
                    ...
                    montoAutorizado = cells[9].textContent.trim();                } else if (tableId === 'contentResolucionesFirmadas') {
                    ...
                    montoAutorizado = getCellValue('Monto') || '0';                } else {
